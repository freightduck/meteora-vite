  ...
  (function () {
    var m,
      ...
      u = function (e) {
        if (((m.className = m.className.replace(/(?:^|\s)siqhide(?!\S)/, '').replace(/(?:^|\s)siqanim(?!\S)/, '')), e)) {
          ...
          $ZSIQChat.isOnboarding()
            ? 2 != $ZSIQWidgetUI.getWidgetState() &&
    ...
    return {
      ...
      constructIframe: function (e, t) {
        if (($ZSIQCookie.get('isiframeenabled') && !$ZSIQChatWindow.getChatWindowDiv()) || !$ZSIQChatWindow.isTrackingOnly() || $ZSIQChat.isPreview()) {
          var i,
            ...
            d = $zohosq.nonce;
          if (
            (m && !_WINDOW_REPOPULATE && (o ? (n = !0) : (m.remove(), (_WINDOW_REPOPULATE = !1))),
            n || (m && m.remove(), ((m = document.createElement('DIV')).innerHTML = '<div id="siqcht" class="zls-prelative" ><iframe id="siqiframe" title="SalesIQ Chatwindow" seamless="seamless" height="460" width="100%" scrolling="no"></iframe></div>'), (m.style.visibility = 'hidden')),
            ...
            m.setAttribute('embedtheme', a.theme),
            m.setAttribute('data-id', 'zsiqembed'),
            (null != s.isSeasonalThemeEnabled ? s.isSeasonalThemeEnabled : $ZSIQChat.isSeasonalTheme()) && window._IS_REVAMP && !$ZSIQChatWindow.isBotChatPreview() && m.classList.add('seasonal-hat'),
            ...
            t ||
            (0 == $zohosq.fileloadtime && $ZSIQWidgetUI.F_WINDOW == $ZSIQWidgetUI.getWidgetState())
          )
            ...
            g && 'show' == g && ((c = 0), r && $ZSIQChatWindow.populateIframe(t)),
              r ||
          ...
          !(function (e) {
            ...
            (i = $ZSIQUtil.getCookieValue('dragpos')) && ((i = JSON.parse(i)), m.setAttribute('style', 'left:' + i.left + ';top:' + i.top)),
            this.handleESCEvent();
        }
      },
          ...
          !window._IS_DEV &&
            (function () {
              ...
              if (iscdnenabled && !$ZSIQChat.isPreview()) {
                var t = $zohosq.nonce,
                  i = {};
                (i[SIQ_FLOAT] = '/salesiq/styles/floatbuttonpostload_L7CmgcUNKtiIUH07ZYq3DoTmb-NY-dsjUnC1tUhE6lIf_Xf5zAIkdYqf94knMuis_.css'),
                  (i[SIQ_BUTTON] = '/salesiq/styles/buttonthemepostload_IeszGAuXtDTxTEJK7timQ5yjglcU8S5IY7ZCdSONgPnd50wpvO3Nkexw-mOCFMo2_.css'),
                  (i[SIQ_PERSONALIZE] = '/salesiq/styles/personalizethemepostload_794x1wFsAPHL4c8VnHmlvxot5Wjr1OoxApnOgEZy3BS5iga9n7ssBJWNVNy9CMtJ_.css');
                var a = e.widgetobj,
          ...
          var e = document.getElementById('siqiframe'),
            ...
            n = function () {
              ...
              e && !_IS_REVAMP && (e.handleStatusCallback(), e.handleAudioCallback()),
                ...
                t && t(),
                (m.className = m.className.replace(/(?:^|\s)siq_showload(?!\S)/, '')),
                i && i(),
      ...
      openChatWindow: function (e, t, i) {
        ...
        m.hasAttribute('drag') || (m.style.top = ''),
          $ZSIQWidgetUI.isCSSTransformSupported()
            ? (u(!0),
              $ZSIQUTSAction.widget_interaction &&
                (f(),
        ...
        if (($ZSIQWidgetUI.setWidgetState($ZSIQWidgetUI.F_WINDOW), IframeHandler.sendPostMessage('iframestate', !0), $ZSIQUtil.getIframe().$Support)) {
          ...
          n.getUnreadCount() && !n.isConversationUIFocussed() && (n.sendReadCall(), n.removeUnreadCookie(), $ZSIQWidgetUI.removeUnreadCount()),
      ...
      closeChatWindow: function (e) {
        $ZSIQUtil.stopBlinking(),
          ...
          u(),
          (m.className = m.className.replace(/(?:^|\s)remtrans(?!\S)/, '')),
      ...
      handleChatWindowVisible: function (e, t, i, a, s) {
        if ($ZSIQChatWindow.isBotChatPreview()) $ZSIQChatWindow.openChatWindow(!0);
          ...
          if (!0 !== $ZSIQWidget.getWidgetObject().hideembed) {
            ...
            (s = s || n),
              (e = e || n) &&
                ('hide' != e || ($ZSIQWidgetUI.getWidgetState() != $ZSIQWidgetUI.F_WINDOW && !$ZSIQChat.isPreview())
                  ? 'show' == e
                    ? ($ZSIQChatWindow.openChatWindow(!1, a, s), i && !$ZSIQUtil.getIframe().$Support.isChatExist() && $ZSIQUtil.getIframe().$Support.openClassicUI())
                    : !isNaN(e) && 0 < e && setTimeout($ZSIQChatWindow.openChatWindow, 1e3 * e, s)
      ...
      getRevampWindowVariables: function (e, t) {
        var i,
          ...
          o = {
            ...
            customcss:
              ((i = JSON.parse(a.props.iscustomcss)),
              {
                enabled: !!i[0],
      ...
      splitJSHashgetSRIVal: function (e) {
        var t = e.split('/').pop();
        return $ZSIQChat.getSubResourceIntegrityAttr(
          t
            .substring(t.indexOf('_') + 1)
            .replace('_.js', '')
            .replace('_.css', '')
            .slice(-64)
        );
      ...
      getFiles: function () {
        ...
        if (window._IS_REVAMP) {
          var a = [];
          return (
            NEW_STATIC_URLS.forEach(function (e) {
              (e = e.slice()), t.isRtlLang ? e.shift() : e.pop(), a.push(e);
            }),
            [this.getRevampWindowVariables(t, e, i)]
              .concat(this.getStaticFileNodes(a[0], 'js'))
              .concat(this.getStaticFileNodes(a[1], 'js', !0))
              .concat(this.getStaticFileNodes(a[2], 'css'))
          );
        }
        var s,
          n = e.commondata,
        ...
        if ((iscdnenabled && ((i.cssstaticfile = '/salesiq/styles/embedtheme' + t.theme + '_' + cssjslist[i.cssstaticfile] + '_.css'), (i.jsstaticfile = '/salesiq/js/siqchatwindow' + t.theme + '_' + cssjslist[i.jsstaticfile] + '_.js')), $ZSIQChatWindow.isNewHeader())) {
          ...
          (i.cssstaticfile = t.isRtlLang ? '/salesiq/styles/embedrtl_Tzps9SxqTIEwNjusYgexXR7OKAqYoZX-nL6OHhZtWptHAFRjvjS1Q17pAATkAibp_.css' : '/salesiq/styles/newembedtheme_VoDcMA7-TmopSQ2IJXgRiivJVYtQEWNgnaXQh2HmpVjQddIOYbnHAd-fH-2FsYQc_.css'),
            (i.jsstaticfile = g ? '/salesiq/js/siqnewchatwindow1_TgVVrBWLdx0addzwvi-VbRMFXWA1vc7wvfHRalvnTuCUbT_WlFYWNg0DUPygeJZ5_.js' : '/salesiq/js/siqnewchatwindow_NZ5-pj5VEQaid6Zp6INt1fy-Qh4CgxrsfZ-5u6fIMvdPSiq_Fm7Uk7P-5bcx1R_f_.js');
        }
        ...
        if (t.ucomp) {
          var u = $zohosq.nonce ? 'nonce ="' + $zohosq.nonce + '"' : '',
            p = n.jscdnstaticserver + '/salesiq/js/embedmedia-rtc_6dfbtc3TKRhvLbtnOM1T4M4Nz-CVWQV2uA6roS31mT6V3Xi9rsJloGtUTI6L_Hbh_.js';
          ...
          w && (f = 'integrity=' + w + ' crossorigin="anonymous"'),
            (s +=
              ...
              '" ' +
              u +
              $ZSIQChatWindow.splitFileHashAndGetSRIattr(i.jsstaticfile) +
              ' ></script><script src="' +
              c +
              '"  onerror="' +
              d +
              '" ' +
              u +
              $ZSIQChatWindow.splitFileHashAndGetSRIattr(c) +
              ' ></script>' +
              l +
              '</head><body></body></html>'),
          ...
          $ZSIQChatWindow.isNewHeader() && ('themeui.js', 'themetemplate.js', 'theme.css', 'themecommon.css'),
      ...
      setLoadContentClass: function () {
        try {
          ...
          -1 != t.className.indexOf('loadframe') || (!$ZSIQChat.isPreview() && -1 == m.className.indexOf('siqanim')) || ((t.className += ' loadframe'), e.handlePostLoadScript(), e.enableHeaderImage());
        } catch (e) {}
      },
      isOnlyCall: function () {
...
var $ZSIQWidgetUI =
  ...
  (function () {
    var I,
      ...
      h = function (e) {
        var t;
        if (((e.status = (t = $ZSIQWidget.getWidgetObject()).call_status || t.status), e.sticker[0] != $ZSIQUtil.STATUS_DISABLE))
          return (g.style.height = ''), (g.style.width = ''), (I = $ZSIQTemplate['theme' + e.sticker[1].default]), (e.clogo_src = $ZSIQUtil.getCompanyLogo(e.clogo_src)), I.getFloatStickerHTML(e);
      ...
      a = function (e, t) {
        ...
        var s =
          ...
          $ZSIQUtil.getImageURL(e, i) +
          '" class="' +
          n +
          '" alt="' +
          a +
          '" height="400" width="400"/><em id="zsiq_unreadcnt" class="zsiq_unrdcnt" style="display: none;"></em><em id="zsiq_avcall" class="zsiqmin_unrdcnt zsiq_unrdcnt siqico-mincall" style="display: none;"></em></div>';
    ...
    return {
          ...
          if (i) {
            if (!$ZSIQChat.isPreview() && i.$Support) {
              ...
              if (l == $ZSIQWidgetUI.F_BUTTON || l == $ZSIQWidgetUI.F_STICKER || n) {
                ...
                a.ispostloaddone || (clearTimeout(a.jsdownloadtimer), a.downloadAdditionalFiles()),
                  $ZSIQWidget.handleCallBacks({
                    'chatbutton.click': '',
                  }),
      ...
      handleResizeEvents: function () {
        $ZSIQChat.isPreview() ||
          handleIframeFunction(function (e) {
      ...
      onLoadCustomSticker: function (e) {
        var t = {},
          ...
          n = e.naturalHeight,
          a = [400 / i, 400 / n];
        (t = 1 < (a = Math.min(a[0], a[1])) ? { WIDTH: i, HEIGHT: n } : { WIDTH: i * a, HEIGHT: n * a }), (g.style.width = t.WIDTH + 'px'), (g.style.height = t.HEIGHT + 'px');
      },
  ...
  (function () {
    ...
    return {
      ...
      handleAPIValues: function () {
        if ('click' == $ZSIQUtil.getAPIValues().chatmode) {
          ...
          $ZSIQWidgetUI.getWidgetState() == $ZSIQWidgetUI.F_STICKER &&
            $ZSIQUtil.bindClickEvent(t, function (t) {
      ...
      handleCallBacks: function (t) {
        try {
          if ($zoho && t) for (var e in t) $zohosq._invoke(e, t[e]);
        } catch (t) {}
      },
      getWidgetStatus: function () {
        return i.status;
