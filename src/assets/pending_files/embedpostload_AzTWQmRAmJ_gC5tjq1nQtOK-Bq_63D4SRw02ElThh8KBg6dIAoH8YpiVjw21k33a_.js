jQuery(function (c) {
  ...
  function n(t) {
    ...
    this._windowEle.on('resize.' + this.widgetName, function (t) {
      ...
      (this._documentEle = c(document)),
      this._documentEle.on('keydown.' + this.widgetName, function (t) {
        27 == t.keyCode && F(t);
      }),
      ...
      c(t).on('mouseover mouseup', function (t) {
        ...
        if (e && o.length && 'document' !== o[0].nodeName.toLowerCase()) {
          ...
          void 0 !== i && '' !== T[i] && (h.callout = i),
            c(w).length && c(w).find('.ui-ztooltip-close').remove(),
            (f = 800),
            (function (o, e) {
              ...
              var n = (function (t) {
                ...
                if (o) f = 0;
                  ...
                  (g = c('<div>').attr('class', 'ui-ztooltip-header ui-corner-top')),
                    (z = c('<div>').attr({
                      class: i + e,
                      id: 'ui-ztooltip-content',
                    })),
                    (W = c('<span>')
                      .attr('class', 'ui-ztooltip-img ' + h.iconclass)
                      .appendTo(n)),
                    g.appendTo(n),
                    z.appendTo(n),
                    n.appendTo(w),
                ...
                if (!h.autohide) {
                  var a = c('<span>')
                    .attr('class', 'ui-ztooltip-close ui-icon ui-components-icon')
                    .on('click', function (t) {
              ...
              if (n) {
                ...
                o.originalEvent
                  ? (a =
                      h.callout && !h.ajaxContent
                        ? k(o)
                        : {
                            left: o.pageX + 10,
                            top: o.pageY + 10,
                          })
                  : (((a = e.offset()).left += e.width()), (a.top += e.height())),
                  (a = _(a, e, d)),
                  clearTimeout(l),
                  clearTimeout(u),
                  (l = setTimeout(function () {
                    if (e.is(':visible') || e.is('option')) {
                      if (h.ajaxContent) {
                        ...
                        c(w).find('.ui-ztooltip-ajaxcontent').append(t),
            ...
            (v = e),
            (m = o).on('click.ztooltip', function (t) {
              F();
            }),
            o.off('mouseout.ztooltip').on('mouseout.ztooltip', function (t) {
              h.timeout && clearTimeout(s),
                a && clearTimeout(a),
            ...
            h.mousetrack &&
              o.off('mousemove.ztooltip').on('mousemove.ztooltip', function (t) {
                !(function (t, o) {
                  var e = c(w),
                    i =
                      (e.width(),
  ...
  function E(t, n) {
    ...
    n ? t.data('parents', void 0) : (o.push(t), t.data('parents', o)),
      o &&
        c.each(o, function (t, o) {
          var e = '',
            i = (o = c(o)).attr('title');
  ...
  function _(t, o, e, i) {
    var n = h.callout ? h.callout : i,
      ...
      u = a.top;
    return (
      o.is('option') && ((l = o.parent('select').offset().left), (u = o.parent('select').offset().top + o.offset.top)),
      n &&
        (-1 != n.indexOf('north')
          ? (h.mouseEnter || h.mousetrack || (t.left = 'northwest' === n ? l : 'northeast' === n ? l - (e.width() - o.outerWidth()) : l - 8 - (e.width() / 2 - 8) + o.outerWidth() / 2), (t.top = u + o.outerHeight() + 9))
          : -1 != n.indexOf('south')
            ? ((t.left = 'southwest' === n ? l : 'southeast' === n ? l - (e.width() - o.outerWidth()) : l - 8 - (e.width() / 2 - 8) + o.outerWidth() / 2), (t.top = u - e.outerHeight() - 9))
            : 'west' === n
              ? ((t.left = parseInt(l + o.outerWidth() + 9)), (t.top = u - e.height() / 2 + o.outerHeight() / 2))
              : 'east' === n && ((t.left = parseInt(l - e.width() - 9)), (t.top = u - e.height() / 2 + o.outerHeight() / 2))),
      t
    );
  }
  function H(t, o) {
    ...
    switch (t) {
      ...
      case 'west':
        ...
        break;
      case 'east':
        e = { left: a - 1 + 'px', top: l / 2 - n / 2 + 'px' };
        break;
      case 'south':
        e = { left: a / 2 - i / 2 + 'px', top: l - 1 + 'px' };
        break;
      case 'northeast':
        e = {
          left: a - 2 * i + 'px',
        ...
        break;
      case 'northwest':
        e = { left: i + 'px', top: '-' + (n - 1) + 'px' };
        break;
      case 'southwest':
        e = { left: i + 'px', top: l - 1 + 'px' };
        break;
      case 'southeast':
        e = { left: a - 2 * i + 'px', top: l - 1 + 'px' };
        break;
      default:
        o.addClass('ui-ztooltip-callout-top'),
          (e = {
            left: i + 'px',
            top: '-' + (n - 1) + 'px',
          });
  ...
  function O(t, o, e, i) {
    if (o && e) {
      var n,
        a = e.top - this._documentEle.scrollTop(),
      ...
      if (
        (u >= this._windowWidth
          ? ((e.left = this._windowWidth - (o.outerWidth(!0) + 5)), e.left + o.width() - i.offset().left <= 15 && (h.callout = 'east'), (r = h.callout))
          : l < 0 && ((e.left = e.left + 5 - l), i.offset().left + i.width() - this._documentEle.scrollLeft() <= 20 && (h.callout = 'west'), (r = h.callout)),
        s >= this._windowEle.height() ? ((e.top = i.offset().top - o.outerHeight() - 9), (r = 'south'), (n = a)) : a < 0 && ((e.top = i.offset().top + i.outerHeight() + 9), (r = 'north'), (n = a)),
        r)
      )
        !(function (t, o, e, i, n, a, l) {
          ...
          (function (t, o, e, i, n, a, l, u) {
            if (e) {
              h.callout = o;
              var s = e.position();
              u && ((s = H(o, e)) || (s = e.position())),
                'east' === o || 'west' === o
                  ? ((s = H(o, e)), (a = _(a, c(t.target), i, n)))
                  : 'northwest' === o || 'northeast' === o || 'southwest' === o || 'southeast' === o
                    ? (s = H(o, e))
                    : l < 0
                      ? ((s.left = i.width() / 2 - e.outerWidth() / 2 + l - 5), s.left <= 10 && (s.left = 10))
                      : ((s.left = i.width() / 2 - e.outerWidth() / 2 + (l - a.left)), i.width() - s.left <= 20 && (s.left = i.width() - 20)),
                s && e.css(s);
            }
          })(t, u, e, i, o, n, a, l);
  ...
  (c.fn.ztooltip = function (t, o, e) {
    ...
    (c.fn.ztooltip.remove = F),
    !$Support.isMobileWidth() && $Support.isIframeContentLoaded() && c(document).ztooltip();
});
LSDragDrop = {
  ...
  uploadFile: function (a, t, e, i) {
    ...
    function r() {
      $UI.hideUploadProgress(s), $Support.Util.handleCallbacks('chat.file', {}), o.pos < o.nooffiles && ((s = new Date().getTime()), o.uploadFileUsingPost(a, t, o.pos, n, s), o.pos++);
    }
    o.uploadFileUsingPost(a, t, o.pos, n, s, l, i), o.pos++;
  },
  ...
  uploadFileUsingPost: function (e, i, a, t, o, s, l) {
    try {
      var n = i[a],
        r = this,
        d = $Support.EmbedObj;
      if ('image/svg+xml' == n.type || (window.ZSIQFileUpload && !ZSIQFileUpload.isWhitelistedFileType(n))) {
        var p = i && 1 == i.length ? 'fileupload.invalid' : 'filesupload.invalid.ignore';
        return ZSIQConversationManager.getChatWinObjById(e).showBanner(LSResource.getRealValue(p), !0), r.pos++, void t.success();
      }
      var u = null != s ? s : 'chat_attachment';
      if (n.size <= 52428800) {
        var c = {
          chid: e,
          dname: d.visitorname,
        ...
        'voice_message' == u && (c.m_id = l);
        var g = r.getFormData(c);
        try {
...
PasteImage = {
  ...
  getHTMLTemplet: function () {
    return this.isUser
      ? "<div id='fileintex-FILEINDEX' purpose='fileupload' CLASS><input type='text' value='' class='file-name' purp='name'/><div id='pasteimage' class='pasteimage'></div><textarea class='pasteimgcomment' id='pasteimgcomment' purp='comment' placeholder='" +
          LSResource.getRealValue('transferchat.comment.placeholder') +
          "'></textarea></div>"
      : $EmbedManger.UI.getPrevHTML();
  },
  getEmbPrevHTML: function () {
    return (
      '<div id="fileintex-FILEINDEX" purpose="fileupload"><div class="imgshr_head txtelips" title="' +
      getEncodedText(Support.attendername) +
      '">' +
      LSResource.getRealValue('common.sharewith', getEncodedText(Support.attendername)) +
      '</div><input type=\'text\' value=\'\' class=\'file-name\' purp=\'name\'/><div class="embd_pstimgdiv" id="pasteimage"></div><textarea id="pasteimgcomment" purp="comment" placeholder="' +
      LSResource.getRealValue('common.comment.placeholder') +
      '"></textarea><div class="pstimg_btns"><span id="uploadimage" class="txtelips strtbtn drkdclr">' +
      LSResource.getRealValue('banner.share') +
      '</span><span id="cancelupload" class="txtelips cnsl">' +
  ...
  updateDetailes: function (e) {
    for (var t = 0, a = this.files, n = a.length; t < n; t++) {
      ...
      var o = s.lastIndexOf('.');
      -1 !== o ? (r = s.substring(o)) : (o = s.length),
        (s = (s = (s = s.substring(0, o)).replace(/[`~!\$%\^&\|\\\"<>\?\/]/g, '-')).substring(0, 100)),
        (this.Filename = s),
        (this.ext = r),
        l.attr('fileextn', r),
        l.find('.file-name').val(s),
        l.find('#pasteimgcomment').focus(),
        this.bindHandler(l),
        this.setPreview(l, i);
    }
  },
  ...
  showEmbedUI: function (e) {
    var t = $('#embedcontainer').find('.flcontainer'),
      a = this.getHTML();
    t.find('.pstimg-main').remove(),
      t.append(a).find('.pstimg-main').show(),
      t.find('#uploadimage').on('click', function () {
  ...
  handleUploadAjax: function (a, e) {
    var t = {},
      ...
      i = '';
    if (
      ('upload.do' === (n ? 'upload.do' : 'upload.ls') && (t = lsnocachefix('json', !0)),
      (t.chid = n ? WindowHandler.getCurrentWinChatID() : $EmbedManger.getChatID()),
      (t.dname = n ? CurrentUser.getDisplayname() : $EmbedManger.getVisitorName()),
      (t.mod = 'att'),
      (t.sid = n ? LSMessanger.getSid() : $EmbedManger.getLiveSupportID()),
      (t.comment = JSON.stringify({})),
      0 != getObjectSize(e) && (t.comment = JSON.stringify(e)),
      n)
    ) {
