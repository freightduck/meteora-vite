/*!Copyright (C) GTranslate Inc.*/ (function () {
  ...
  if (float_switcher_open_direction == 'left' || float_switcher_open_direction == 'right') {
    ...
    widget_css +=
      '.gt_float_switcher .gt_options{position:relative;z-index:777;white-space:nowrap;float:' + float_switcher_open_direction + ';max-width:' + max_width + ';overflow:hidden;transform:translateX(-' + window.innerWidth + 'px);opacity:0;cursor:pointer;transition:all .8s cubic-bezier(.3,1.1,.4,1.1)}';
